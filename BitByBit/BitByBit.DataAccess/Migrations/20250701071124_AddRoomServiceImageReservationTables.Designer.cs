...
namespace BitByBit.DataAccess.Migrations
{
    ...
    [Migration("20250701071124_AddRoomServiceImageReservationTables")]
    partial class AddRoomServiceImageReservationTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BitByBit.Entities.Models.Images", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BitByBit.Entities.Models.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BitByBit.Entities.Models.Room", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BitByBit.Entities.Models.Services", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BitByBit.Entities.Models.User", b =>
                {
            ...
            modelBuilder.Entity("BitByBit.Entities.Models.Images", b =>
                {
                    b.HasOne("BitByBit.Entities.Models.Room", "Room")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("BitByBit.Entities.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("BitByBit.Entities.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BitByBit.Entities.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
